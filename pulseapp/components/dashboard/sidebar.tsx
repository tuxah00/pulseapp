...
const bottomNav = [
  // Hesabım sayfası ayarlar hub'ı içinde kart olarak yer alıyor (sidebar tek
  // satır kalsın, görsel kalabalık olmasın).
...
const PERMISSION_MAP: Record<string, keyof StaffPermissions> = {
  ...
  '/dashboard/assistant-actions': 'assistant_actions',
