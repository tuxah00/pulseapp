...
export default function AnalyticsPage() {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Sekmeler */}
      <div className="sticky top-14 z-20 -mx-4 px-4 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8 bg-gray-50 dark:bg-gray-950 flex gap-1 border-b border-gray-200 dark:border-gray-700 overflow-x-auto whitespace-nowrap">
        {([
