...
const SECTOR_CONTEXT: Record<SectorType, string> = {
  hair_salon: 'kuaför/berber salonunda saç kesimi, boyama, bakım hizmetleri sunulmaktadır',
  beauty_salon: 'güzellik salonunda cilt bakımı, manikür, pedikür, epilasyon hizmetleri sunulmaktadır',
  dental_clinic: 'diş kliniğinde diş tedavisi, dolgu, kanal tedavisi, diş beyazlatma hizmetleri sunulmaktadır',
  psychologist: 'psikoloji kliniğinde bireysel terapi, çift terapisi, aile danışmanlığı hizmetleri sunulmaktadır',
  lawyer: 'hukuk bürosunda hukuki danışmanlık, dava takibi hizmetleri sunulmaktadır',
  restaurant: 'restoranda yemek servisi, rezervasyon hizmetleri sunulmaktadır',
  cafe: 'kafede içecek ve hafif yiyecek servisi sunulmaktadır',
  auto_service: 'oto serviste araç bakım, onarım, yağ değişimi, lastik değişimi hizmetleri sunulmaktadır',
  veterinary: 'veteriner kliniğinde evcil hayvan muayenesi, aşılama, tedavi hizmetleri sunulmaktadır',
  physiotherapy: 'fizyoterapi merkezinde fizik tedavi, rehabilitasyon, manuel terapi hizmetleri sunulmaktadır',
